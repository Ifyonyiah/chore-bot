...
f = open(r'/Users/admin/Documents/Python Chore Bot/corpus.txt','r',errors = 'ignore')
...
sent_tokens = nltk.sent_tokenize(raw) # converts text to list of sentences
word_tokens = nltk.word_tokenize(raw) # converts text to list of words
                    ...
                    if (greeting(user_response) != None):
                        ...
                        if ("python" in user_response):
                            ...
                            for i in range(100):
                                print("\n")
                            print(
                                "Entering file combining mode. Please enter the exact directory we will be combining.")
                            directory = input(">")
                            os.chdir(directory)
                            ...
                            bot1.pdf_merge_tree()
                        elif("clean" and "directory" in user_response):
                            for i in range(100):
                                print("\n")
                            print("Entering directory cleaning mode. Please enter the exact directory we will be combining.")
                            directory = input(">")
                            os.chdir(directory)
                            clean_directory.Clean(directory)
                        else:
                            print("Bot: ", end="")
